...
class CreateContasPagarReceberTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('contas_pagar_receber', function (Blueprint $table) {
            ...
            $table->varchar('situacao', 45)->nullable();
            ...
            $table->varchar('houve_reativacao',10)->nullable();
            ...
            $table->varchar('justificativa_cancelamento')->nullable();
            $table->varchar('observacoes')->nullable();
            ...
            $table->varchar('historico_de_acoes_duplicata')->nullable();
